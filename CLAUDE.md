...
Dieses Dokument ist das Gedächtnis des Projekts. Wenn du hier etwas Falsches oder
Veraltetes findest, korrigiere es im selben Commit wie die Änderung, die es veraltet hat.
...
falsch. Frag lieber nach, bevor du sie umsetzt.
...
Sortierung, Einrückungsberechnung. Alles dort ist pur und testbar. Wenn du Logik in eine
Komponente schreiben willst, prüfe zuerst, ob sie nach `/domain` gehört.
...
- Wenn du eine bestehende Entscheidung für falsch hältst, sag es. Stillschweigend am
  Modell vorbeizubauen ist der teuerste Fehler in diesem Projekt.
