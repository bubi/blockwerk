...
-- here for convenience; the real client generates UUIDv7/ULID.

-- ============================================================
-- templates (matches prototype/blockwerk.jsx's DEFAULT_TEMPLATES)
-- ============================================================
INSERT INTO templates (id, label, hue, seed, created_at, updated_at) VALUES
...
INSERT INTO items (id, block_id, kind, position, text, heading, created_at, updated_at) VALUES
...
INSERT INTO items (id, block_id, kind, position, text, due_date, assignee_space_id, created_at, updated_at) VALUES
...
INSERT INTO items (id, block_id, kind, position, text, event_date, event_time, created_at, updated_at) VALUES
...
INSERT INTO items (id, block_id, kind, position, text, due_date, assignee_space_id, done, created_at, updated_at) VALUES
  ('b3-t1', 'b3', 'task', 4000, 'Gesprächsleitfaden schicken', '2026-08-02', 'amira', 1, 1754000000000, 1754000000000);

-- b4: Woche sortieren
INSERT INTO items (id, block_id, kind, position, text, created_at, updated_at) VALUES
